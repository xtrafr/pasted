      ...
      <div className="w-full h-full flex flex-col items-center justify-center px-8 py-6 gap-y-6 overflow-auto">
        <div className="flex flex-col items-center gap-y-5 text-center">
          ...
          <div className="select-none">
            <h1 className="text-2xl font-semibold text-zinc-900 mb-2">welcome to Pasted</h1>
            <p className="text-sm text-zinc-600">open an existing library or create a new one</p>
          </div>
        </div>
        {libraries.length > 0 && (
